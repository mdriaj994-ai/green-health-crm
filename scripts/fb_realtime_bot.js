...
function getClinicalConsultationReply(senderId = "", senderName = "", customerMessage = "", isVoiceMode = false) {
  ...
  const prof = senderId ? customerMemory.getCustomerProfile(senderId, senderName) : { symptoms: [] };
  ...
  // Check which clinical information is missing
  ...
  // Check if customer just answered something specific in this message
  const answeredAgeJustNow = Boolean(prof.age && (clean.includes("বয়স") || clean.includes("বয়েস") || clean.includes("boyos") || clean.includes("age") || /^[০-৯0-9]{2}$/.test(clean)));
  const answeredMarriageJustNow = Boolean(prof.maritalStatus && (clean.includes("বিবাহিত") || clean.includes("অবিবাহিত") || clean.includes("বিয়ে") || clean.includes("বিয়া") || clean.includes("married")));
  const answeredBloodJustNow = Boolean(prof.bloodGroup && (clean.includes("গ্রুপ") || clean.includes("পজিটিভ") || clean.includes("নেগেটিভ") || clean.includes("blood")));
  const answeredDurationJustNow = Boolean(prof.duration && (clean.includes("ধরে") || clean.includes("যাবত") || clean.includes("বছর") || clean.includes("মাস") || clean.includes("দিন")));
  const answeredMedicationJustNow = Boolean(prof.previousMedication && (clean.includes("ওষুধ") || clean.includes("খাইছি") || clean.includes("খেয়েছি") || clean.includes("টাইম") || clean.includes("খাইনি")));

  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 5: ALL KEY CLINICAL FACTS ARE COLLECTED -> CONFIDENT DIAGNOSIS & OFFER
  // ──────────────────────────────────────────────────────────────────────────
  if (hasAge && hasDuration && hasMarriage && (hasBloodOrChronic || hasMedicationHistory)) {
    if (isVoiceMode) {
      const voiceDiagnosis = [
        `আলহামদুলিল্লাহ ${nameSalute}, আপনার সবগুলো শারীরিক তথ্য আমি পুঙ্খানুপুঙ্খভাবে দেখেছি। আপনার বয়স ${prof.age || "উপযুক্ত"} বছর, আপনি ${prof.maritalStatus || "সম্মানিত ভাই"}, এবং সমস্যাটি ${prof.duration || "কিছুদিন"} ধরে ফেস করছেন। আপনার এই শারীরিক অবস্থার জন্য কোনো কৃত্রিম কেমিক্যাল ছাড়া আমাদের এক মাসের ফুল কোর্স খাঁটি কস্তুরী পাউডার শতভাগ উপযুক্ত। এটি দুর্বল স্নায়ুতে প্রাকৃতিক শক্তি ফিরিয়ে দিয়ে দ্রুত বীর্যপাত স্থায়ীভাবে বন্ধ করবে। অফার মূল্য মাত্র দুই হাজার আটশত টাকা। অর্ডার কনফার্ম করতে পাঁচশত টাকা অগ্রিম বিকাশ বা নগদ হেল্পলাইন নম্বর শূন্য এক আট সাত শূন্য, শূন্য দুই তিন আট শূন্য চার-এ দিতে হয়, বাকি দুই হাজার তিনশত টাকা পার্সেল হাতে পেয়ে ডেলিভারি ম্যানকে দেবেন। আপনার কোর্সটি কি আজই বুকিং করে দেব ভাইয়া?`,
        ...
        `ধন্যবাদ ${nameSalute} আপনার শারীরিক অবস্থা শেয়ার করার জন্য। আপনার হিস্ট্রি অনুযায়ী ভেষজ চিকিৎসার মাধ্যমে এটি স্থায়ীভাবে নিরাময় সম্ভব। আমাদের এক মাসের ফুল কোর্স খাঁটি কস্তুরী পাউডারের প্রাকৃতিক উপাদান আপনার শরীরের রক্তসঞ্চালন বৃদ্ধি করে স্বাভাবিক মিলন সময় বিশ থেকে পঁচিশ মিনিট পর্যন্ত বাড়িয়ে দেবে। ফুল কোর্সের অফার মূল্য মাত্র দুই হাজার আটশত টাকা। শুধু পাঁচশত টাকা অগ্রিম আমাদের হেল্পলাইন নম্বরে বুকিং করে বাকি দুই হাজার তিনশত টাকা কুরিয়ারে পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন। আপনি কি আজই কোর্সটি শুরু করতে চাচ্ছেন ভাইয়া?`,

        `${nameSalute}, আপনার শারীরিক বিবরণ ও বয়স অনুসারে আমাদের অভিজ্ঞ ইউনানী বোর্ডের সিদ্ধান্ত—আপনার জন্য এক মাসের ফুল কোর্স খাঁটি কস্তুরী পাউডারই সর্বোচ্চ কার্যকরী ও নিরাপদ সমাধান। কোনো পার্শ্বপ্রতিক্রিয়া ছাড়াই এটি স্থায়ী সক্ষমতা নিশ্চিত করে। অর্ডার বুকিংয়ের জন্য পাঁচশত টাকা অগ্রিম বিকাশ বা নগদে আমাদের হেল্পলাইন নম্বরে পাঠিয়ে বাকি দুই হাজার তিনশত টাকা পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন। আপনার জন্য কি পার্সেলটি বুকিং করব ভাইয়া?`
      ];
      return voiceDiagnosis[Math.floor(Math.random() * voiceDiagnosis.length)];
    }

    const textDiagnosis = [
      `আলহামদুলিল্লাহ ${nameSalute}, আপনার সবগুলো শারীরিক তথ্য আমি পুঙ্খানুপুঙ্খভাবে বিশ্লেষণ করেছি। আপনার বয়স ${prof.age || "উপযুক্ত"} বছর, আপনি ${prof.maritalStatus || "সম্মানিত ভাই"}, এবং সমস্যাটি ${prof.duration || "কিছুদিন"} ধরে ফেস করছেন।
...
ফুল কোর্সের অফার মূল্য মাত্র ২,৮০০ টাকা (অর্ডার বুকিংয়ে ৫০০ টাকা অগ্রিম বিকাশ বা নগদে আমাদের অফিসিয়াল হেল্পলাইন: 01870-023804 নম্বরে পরিশোধ করতে হয়, বাকি ২,৩০০ টাকা কুরিয়ারে পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন)। আপনার ফুল কোর্সটি কি আজই বুকিং করে দেব ভাইয়া?`,
      ...
      `মাশাআল্লাহ ${nameSalute}, আপনার মেডিকেল হিস্ট্রি গভীরভাবে পর্যালোচনা করলাম। যেহেতু আপনার বয়স ${prof.age || "উপযুক্ত"} এবং সমস্যাটি ${prof.duration || "কিছুদিন"} যাবত, তাই কোনো সিন্থেটিক কেমিক্যাল ছাড়াই আমাদের প্রাকৃতিক কস্তুরী ও হিমালয়ান শিলাজিৎ ফর্মুলা আপনার টেস্টোস্টেরন বৃদ্ধি করে ধাতু আঠার মতো ঘন করবে ও স্থায়ী শক্তি ফিরিয়ে দেবে।

সারা দেশে ক্যাশ অন ডেলিভারিতে হোম ডেলিভারি দেওয়া হয়। ফুল কোর্সের বর্তমান অফার প্রাইস মাত্র ২,৮০০ টাকা (বুকিং নিশ্চিত করতে ৫০০ টাকা অগ্রিম বিকাশ/নগদে হেল্পলাইন 01870-023804 নম্বরে দিতে হয়, বাকি ২,৩০০ টাকা পার্সেল বুঝে পেয়ে ডেলিভারি ম্যানকে দেবেন)। আপনার নাম ও ঠিকানা দিলে কি আজই বুকিং করে পাঠিয়ে দেব ভাইয়া?`,

      `ধন্যবাদ ${nameSalute} আপনার শারীরিক অবস্থা বিস্তারিত শেয়ার করার জন্য। আপনার হিস্ট্রি অনুযায়ী ভেষজ চিকিৎসার মাধ্যমে এটি সম্পূর্ণ ও স্থায়ীভাবে নিরাময়যোগ্য। আমাদের ১ মাসের ফুল কোর্স (২৫০ গ্রাম) কস্তুরী পাউডারের প্রাকৃতিক উপাদান আপনার শরীরের রক্তসঞ্চালন বৃদ্ধি করে নার্ভকে ভেতর থেকে মজবুত করবে।
...
কোর্সটির বর্তমান স্পেশাল অফার প্রাইস মাত্র ২,৮০০ টাকা (৫০০ টাকা অগ্রিম বুকিং বিকাশ/নগদে হেল্পলাইন 01870-023804 নম্বরে পাঠাতে হয়, বাকি ২,৩০০ টাকা কুরিয়ারে পেয়ে দেখে দেবেন)। আপনি কি আজই কোর্সটি শুরু করতে চাচ্ছেন ভাইয়া?`,
      ...
      `${nameSalute}, আপনার শারীরিক বিবরণ ও বয়স অনুসারে আমাদের অভিজ্ঞ চিকিৎসক বোর্ডের সিদ্ধান্ত—আপনার জন্য ২৫০ গ্রামের ১ মাসের ফুল কোর্স 'কস্তুরী পাউডার'-ই সর্বোচ্চ কার্যকরী ও নিরাপদ সমাধান। কোনো পার্শ্বপ্রতিক্রিয়া ছাড়াই এটি স্থায়ী সক্ষমতা নিশ্চিত করে।
...
অর্ডার বুকিংয়ের জন্য ৫০০ টাকা অগ্রিম বিকাশ বা নগদে আমাদের হেল্পলাইন 01870-023804 নম্বরে পাঠিয়ে বুকিং করতে হয়, বাকি ২,৩০০ টাকা পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন। আপনার জন্য কি পার্সেলটি আজই বুকিং করব ভাইয়া?`
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 4: HAS AGE, DURATION, MARRIAGE -> ASK MEDICATION & BAD HABITS
  // ──────────────────────────────────────────────────────────────────────────
  if (hasAge && hasDuration && hasMarriage && !hasMedicationHistory && (hasBloodOrChronic || answeredBloodJustNow)) {
    const stage4Variations = [
      `মাশাআল্লাহ ${nameSalute}, ব্লাড ও শারীরিক সুস্থতার তথ্যটি নোট করে নিলাম। চিকিৎসার সঠিক ফাইল প্রস্তুত করতে শেষ একটি প্রশ্ন ছিল ভাইয়া—এর আগে কি কোনো ডাক্তার বা ফার্মেসির কেমিক্যাল ওয়ান-টাইম ওষুধ খেয়েছিলেন? আর অতীতে অতিরিক্ত স্বপ্নদোষ বা হস্তমৈথুনের কোনো সমস্যা ছিল কি?`,

      `ধন্যবাদ ${nameSalute}। সম্পূর্ণ নিরাপদ ভেষজ কোর্স নিশ্চিত করার জন্য শেষ আরেকটি বিষয় জানা দরকার—এর আগে কি কোনো যৌন উত্তেজক ওষুধ সেবন করেছিলেন? আর অতীতে অতিরিক্ত ভুলের কারণে কি নার্ভ ক্ষতিগ্রস্ত হয়েছিল ভাইয়া?`,

      `জি ${nameSalute}, তথ্যটি সংরক্ষণে রাখলাম। আপনার নার্ভের রুট কজ নিশ্চিত করতে বলুন—আগে কি কোনো এলোপ্যাথিক বা ওয়ান-টাইম ওষুধ খেয়েছেন? আর অতীতে হস্তমৈথুন বা ধাতু ক্ষয়ের কোনো ইতিহাস ছিল কি?`,

      `আলহামদুলিল্লাহ ${nameSalute}, চমৎকার তথ্য দিয়েছেন। চিকিৎসার শেষ ধাপ হিসেবে শুধু বলুন—এর আগে কি কোনো চিকিৎসা নিয়েছিলেন? আর অতীতে কোনো বদভ্যাসের কারণে কি দুর্বলতা অনুভব করেছিলেন ভাইয়া?`
    ];
    return stage4Variations[Math.floor(Math.random() * stage4Variations.length)];
  }

  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 3: HAS AGE, DURATION, MARRIAGE -> ASK BLOOD GROUP & DIABETES/BP
  // ──────────────────────────────────────────────────────────────────────────
  if (hasAge && hasDuration && hasMarriage && !hasBloodOrChronic) {
...
২) আপনার কি ডায়াবেটিস বা উচ্চ রক্তচাপ (হাই প্রেশার) আছে কিনা?`,
      ...
      `ধন্যবাদ ${nameSalute}, আপনার বৈবাহিক তথ্যটি নোট করলাম। আমাদের ভেষজ ফর্মুলার সর্বোচ্চ কার্যকারিতা নিশ্চিত করতে বলুন—আপনার রক্তের গ্রুপ জানা থাকলে জানাবেন। পাশাপাশি আপনার ডায়াবেটিস বা প্রেশারের কোনো সমস্যা আছে কি ভাইয়া?`,

      `জি ${nameSalute}, দাম্পত্য জীবনের সুখ ও আত্মবিশ্বাস ফিরিয়ে দিতে এটি খুব দ্রুত কাজ করবে। ওষুধের সঠিক মাত্রা নির্ধারণে—আপনার রক্তের গ্রুপ কি জানা আছে? আর শরীরে ডায়াবেটিস বা প্রেশার জাতীয় কোনো সমস্যা আছে কিনা একটু জানাবেন।`,

      `খুবই গুরুত্বপূর্ণ তথ্য দিলেন ভাইয়া। আপনার স্বাস্থ্য সুরক্ষায় আরেকটি বিষয়—আপনার ব্লাড গ্রুপ কী? আর ডায়াবেটিস বা হাই প্রেশার আছে কি না একটু জানাবেন ভাইয়া।`
    ];
    return stage3Variations[Math.floor(Math.random() * stage3Variations.length)];
  }

  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 2: HAS AGE & DURATION -> ASK MARITAL STATUS & MARRIAGE DURATION
  // ──────────────────────────────────────────────────────────────────────────
  if (hasAge && hasDuration && !hasMarriage) {
    const stage2Variations = [
      `আলহামদুলিল্লাহ ${nameSalute}, আপনার বয়স ${prof.age} বছর এবং সমস্যাটি ${prof.duration} ধরে জেনে বিস্তারিত বুঝতে পারলাম। এই বয়সে প্রাকৃতিক ভেষজে নার্ভ খুব দ্রুত সক্রিয় হয়। চিকিৎসার সঠিক গাইডলাইন ও পারফেক্ট ডোজের জন্য আরেকটি বিষয় জানা খুব জরুরি—আপনি কি বিবাহিত নাকি অবিবাহিত ভাইয়া? আর বিয়ে কতদিন বা কত বছর হলো?`,

      `ধন্যবাদ ${nameSalute} তথ্যগুলো স্পষ্ট করার জন্য। ${prof.age} বছর বয়সে সঠিক ভেষজ চিকিৎসা নিলে দুর্বলতা দ্রুত স্থায়ীভাবে সেরে যায়। আপনার সঠিক চিকিৎসার পরামর্শ দিতে আরেকটি বিষয় জানা দরকার—আপনি কি বিবাহিত ভাইয়া? বিয়ে কতদিন হলো, নাকি অবিবাহিত?`,

      `জি ${nameSalute}, বয়স ও সমস্যার মেয়াদ আমি গুরুত্ব সহকারে নোট করেছি। আপনার উপযুক্ত কোর্স নির্ধারণের জন্য একটু বলবেন কি—আপনি কি বিয়ে করেছেন? বিয়ে কতদিন হলো, নাকি এখনও অবিবাহিত?`,
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 1 (PARTIAL): CUSTOMER ANSWERED AGE BUT NOT DURATION
  // ──────────────────────────────────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 1 (PARTIAL): CUSTOMER ANSWERED DURATION BUT NOT AGE
  // ──────────────────────────────────────────────────────────────────────────
  if (!hasAge && hasDuration) {
  ...
  // ──────────────────────────────────────────────────────────────────────────
  // STAGE 1 (INITIAL): ASKING FOR DETAILS / HOW IT WORKS / WHAT TO TAKE
  // ──────────────────────────────────────────────────────────────────────────
