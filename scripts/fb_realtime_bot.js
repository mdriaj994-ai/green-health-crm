  ...
  if (hasAge && (hasDuration || hasPathology) && hasMarriage && (hasBloodOrChronic || hasMedicationHistory || aspectsCount >= 5)) {
    if (isVoiceMode) {
      const voiceDiagnosis = [
        `আলহামদুলিল্লাহ ${nameSalute}, আপনার শারীরিক বিবরণ পুঙ্খানুপুঙ্খভাবে আমি ও আমাদের ইউনানী চিকিৎসক দল পর্যালোচনা করেছি। আপনার বয়স ${prof.age || "উপযুক্ত"} বছর, আপনি ${prof.maritalStatus || "সম্মানিত ভাই"}, এবং সমস্যাটি ${prof.duration || "বেশ কিছুদিন"} ধরে ফেস করছেন। আপনার এই শারীরিক অবস্থার জন্য কোনো কৃত্রিম কেমিক্যাল বা ক্ষতিকর ওয়ান-টাইম ড্রাগ ছাড়াই আমাদের এক মাসের ফুল কোর্স খাঁটি কস্তুরী পাউডার শতভাগ উপযুক্ত ও নিরাপদ। এটি দুর্বল স্নায়ু সতেজ করে সহবাসের স্বাভাবিক সময় বিশ থেকে পঁচিশ মিনিট পর্যন্ত বাড়িয়ে দেবে এবং পাতলা বীর্য আঠার মতো ঘন করবে। অফার মূল্য মাত্র দুই হাজার আটশত টাকা। অর্ডার কনফার্ম করতে দুইশত টাকা অগ্রিম আমাদের বিকাশ হেল্পলাইন নম্বর শূন্য এক আট সাত শূন্য, শূন্য দুই তিন আট শূন্য চার-এ দিতে হয়, আর বাকি দুই হাজার ছয়শত টাকা পার্সেল হাতে পেয়ে দেখে ডেলিভারি ম্যানকে দেবেন। আপনার কোর্সটি কি আজই বুকিং করে দেব ভাইয়া?`,

        `মাশাআল্লাহ ${nameSalute}, আপনার মেডিকেল হিস্ট্রি পুঙ্খানুপুঙ্খভাবে বিশ্লেষণ করলাম। যেহেতু আপনার বয়স ${prof.age || "উপযুক্ত"} এবং সমস্যাটি ${prof.duration || "কিছুদিন"} যাবত, তাই সিন্থেটিক কেমিক্যাল ছাড়াই আমাদের প্রাকৃতিক মৃগনাভি কস্তুরী ও হিমালয়ান শিলাজিৎ ফর্মুলা আপনার টেস্টোস্টেরন বৃদ্ধি করে ধাতু আঠার মতো ঘন করবে ও স্থায়ী শক্তি ফিরিয়ে দেবে। সারা দেশে ক্যাশ অন ডেলিভারিতে পাঠানো হয়। অফার প্রাইস মাত্র দুই হাজার আটশত টাকা। বুকিং নিশ্চিত করতে দুইশত টাকা অগ্রিম আমাদের বিকাশ হেল্পলাইন নম্বর শূন্য এক আট সাত শূন্য, শূন্য দুই তিন আট শূন্য চার-এ দিতে হয়, আর বাকি দুই হাজার ছয়শত টাকা পার্সেল বুঝে পেয়ে দেবেন। আপনার নাম ও ঠিকানা দিলে কি আজই পাঠিয়ে দেব ভাইয়া?`,

        `ধন্যবাদ ${nameSalute} আপনার শারীরিক অবস্থা বিস্তারিত শেয়ার করার জন্য। আপনার হিস্ট্রি অনুযায়ী কোনো ক্ষতিকর পার্শ্বপ্রতিক্রিয়া ছাড়াই ভেষজ চিকিৎসার মাধ্যমে এটি স্থায়ীভাবে নিরাময় সম্ভব। আমাদের এক মাসের ফুল কোর্স খাঁটি কস্তুরী পাউডারের প্রাকৃতিক উপাদান আপনার শরীরের রক্তসঞ্চালন বৃদ্ধি করে স্বাভাবিক মিলন সময় বিশ থেকে পঁচিশ মিনিট পর্যন্ত বাড়িয়ে দেবে। ফুল কোর্সের অফার মূল্য মাত্র দুই হাজার আটশত টাকা। শুধু দুইশত টাকা অগ্রিম আমাদের হেল্পলাইন নম্বর শূন্য এক আট সাত শূন্য, শূন্য দুই তিন আট শূন্য চার-এ বুকিং করে বাকি দুই হাজার ছয়শত টাকা কুরিয়ারে পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন। আপনি কি আজই কোর্সটি শুরু করতে চাচ্ছেন ভাইয়া?`,

        `${nameSalute}, আপনার শারীরিক বিবরণ ও বয়স অনুসারে আমাদের অভিজ্ঞ ইউনানী বোর্ডের সিদ্ধান্ত—আপনার জন্য এক মাসের ফুল কোর্স খাঁটি কস্তুরী পাউডারই সর্বোচ্চ কার্যকরী ও নিরাপদ সমাধান। কোনো পার্শ্বপ্রতিক্রিয়া ছাড়াই এটি স্থায়ী সক্ষমতা নিশ্চিত করে। অর্ডার বুকিংয়ের জন্য দুইশত টাকা অগ্রিম বিকাশে আমাদের হেল্পলাইন নম্বর শূন্য এক আট সাত শূন্য, শূন্য দুই তিন আট শূন্য চার-এ পাঠিয়ে বাকি দুই হাজার ছয়শত টাকা পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন। আপনার জন্য কি পার্সেলটি বুকিং করব ভাইয়া?`
      ];
...
ফুল কোর্সের অফার মূল্য মাত্র ২,৮০০ টাকা (অর্ডার বুকিংয়ে ২০০ টাকা অগ্রিম বিকাশে আমাদের অফিসিয়াল হেল্পলাইন: 01870-023804 নম্বরে পরিশোধ করতে হয়, বাকি ২,৬০০ টাকা কুরিয়ারে পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন)। আপনার ফুল কোর্সটি কি আজই বুকিং করে দেব ভাইয়া?`,
...
ফুল কোর্সের বর্তমান অফার প্রাইস মাত্র ২,৮০০ টাকা (বুকিং নিশ্চিত করতে ২০০ টাকা অগ্রিম বিকাশে হেল্পলাইন 01870-023804 নম্বরে দিতে হয়, বাকি ২,৬০০ টাকা পার্সেল বুঝে পেয়ে ডেলিভারি ম্যানকে দেবেন)। আপনার নাম ও সম্পূর্ণ ঠিকানা দিলে কি আজই বুকিং করে পাঠিয়ে দেব ভাইয়া?`,
...
কোর্সটির বর্তমান স্পেশাল অফার প্রাইস মাত্র ২,৮০০ টাকা (২০০ টাকা অগ্রিম বুকিং বিকাশে হেল্পলাইন 01870-023804 নম্বরে পাঠাতে হয়, বাকি ২,৬০০ টাকা কুরিয়ারে পেয়ে দেখে দেবেন)। আপনি কি আজই কোর্সটি শুরু করতে চাচ্ছেন ভাইয়া?`,
...
অর্ডার বুকিংয়ের জন্য ২০০ টাকা অগ্রিম বিকাশে আমাদের হেল্পলাইন 01870-023804 নম্বরে পাঠিয়ে বুকিং করতে হয়, বাকি ২,৬০০ টাকা পার্সেল হাতে পেয়ে দেখে পরিশোধ করবেন। আপনার জন্য কি পার্সেলটি আজই বুকিং করব ভাইয়া?`
    ];
...
async function generateReply(customerMessage, senderName, senderId = null, recentHistory = [], pageName = "গ্রীন হেলথ ইউনানী ফার্মেসী", isVoiceMode = false) {
  ...
  if (senderId) {
    ...
    // ── Page-specific dynamic product variables (Health Care vs Natural Herbal) ──
...
বাকি পুরো ${pageProductRemaining} কিন্তু পার্সেল হাতে পেয়ে, খুলে দেখে তারপর কুরিয়ার ম্যানকে দেবেন। আপনার কোনো ঝুঁকি নেই ভাইয়া।
...
বাকি ${pageProductRemaining} আপনি পার্সেল হাতে পেয়ে, চেক করে ডেলিভারিম্যানকে পরিশোধ করবেন। এখানে আপনার ১ টাকারও কোনো ঝুঁকি নেই ভাইয়া। আপনার সুস্থতার জন্য এই ফ্রেশ ফাইলটি কি রেডি করব?`,
...
আমাদের এটি হাকীম মো: আব্দুল করিম সাহেবের নিজস্ব ফর্মুলায় ল্যাব থেকে তৈরি সম্পূর্ণ প্রাকৃতিক ও পরীক্ষিত ফর্মুলা। আপনার রোগ ও বয়সের উপর ভিত্তি করে ফ্রেশভাবে তৈরি করা হয় বলেই আমরা শুধু ২০০ টাকা বুকিং নিই, যাতে ওষুধটি অপচয় না হয়। বাকি ${pageProductRemaining} আপনি পার্সেল হাতে পেয়ে দেখে দেবেন।
...
CURRENT PAGE FOCUS & PRIMARY PRODUCT:
এই পেজটি হলো: "${isNaturalHerbal ? 'ন্যাচারাল হারবাল' : 'হেলথ কেয়ার'}"
${isNaturalHerbal 
  ? 'এই পেজের প্রধান ও অফিশিয়াল প্রোডাক্ট হলো: "বাজীকরণ হালুয়া" (৩৫০ গ্রাম, অফার মূল্য ২,০০০ টাকা, বুকিং ২০০ টাকা অগ্রিম বিকাশ 01870-023804 নম্বরে, বাকি ১,৮০০ টাকা ক্যাশ অন ডেলিভারি)। রোগীর সমস্যা শুনে বা প্রোডাক্ট সাজেস্ট করার সময় সর্বদা বাজীকরণ হালুয়া সাজেস্ট করবে এবং কস্তুরী পাউডারের মতো একই আন্তরিকতা, সম্মান ও চিকিৎসা প্রোটোকল মেনে কথা বলবে।'
  : 'এই পেজের প্রধান ও অফিশিয়াল প্রোডাক্ট হলো: "কস্তুরী পাউডার" (২৫০ গ্রাম, ১ মাসের ফুল কোর্স, অফার মূল্য ২,৮০০ টাকা, বুকিং ২০০ টাকা অগ্রিম বিকাশ 01870-023804 নম্বরে, বাকি ২,৬০০ টাকা ক্যাশ অন ডেলিভারি)। রোগীর সমস্যা শুনে বা প্রোডাক্ট সাজেস্ট করার সময় সর্বদা কস্তুরী পাউডার সাজেস্ট করবে।'
}
চিকিৎসক: হাকীম মো: আব্দুল করিম, জনতা ইউনানী চিকিৎসালয়, দোকান ৩৩ (৩য় তলা), আলীকদম, বান্দরবান পার্বত্য জেলা।
...
- পেমেন্ট রুল (Mandatory): কস্তুরী পাউডার অর্ডার কনফার্ম করতে ২০০ টাকা অগ্রিম বিকাশে (বিকাশ পার্সোনাল হেল্পলাইন নম্বর: 01870-023804) পরিশোধ করতে হবে; বাকি ২,৬০০ টাকা কুরিয়ারে পণ্য হাতে পেয়ে ক্যাশ অন ডেলিভারিতে পরিশোধ করবেন।
...
- মূল্য ও শর্তাবলী: অফার মূল্য ২,০০০ টাকা। পার্সেল বুকিং নিশ্চিত করতে ২০০ টাকা অগ্রিম বিকাশ প্রযোজ্য (বিকাশ পার্সোনাল হেল্পলাইন: 01870-023804); বাকি ১,৮০০ টাকা পার্সেল হাতে পেয়ে দেখে ডেলিভারিম্যানকে পরিশোধ করবেন।
- চিকিৎসক / হাকিম: হাকীম মো: আব্দুল করিম (বাংলাদেশ বোর্ড অব ইউনানী এন্ড আয়ুর্বেদিক সিস্টেমস অব মেডিসিন, স্বাস্থ্য মন্ত্রণালয় কর্তৃক ক্যাটাগরি-এ নিবন্ধিত হাকীম, রেজি নং: ৫৮৪২/২০১৮), জনতা ইউনানী চিকিৎসালয়, দোকান নং- ৩৩, ৩য় তলা, আলীকদম, বান্দরবান পার্বত্য জেলা।
...
1. FACTUAL & SCIENTIFIC ACCURACY (সঠিক ও নির্ভুল তথ্য):
   ...
   - For AMBER Premium (অंबर / অম্বর):
     ...
     * মূল্য: অফার মূল্য ২,৮০০ টাকা লাগবে (রেগুলার ৩,৫০০ টাকা)।
...
2. EXPLICIT NUMERIC PRICING (টাকার কথা সংখ্যায় বলা - "এত টাকা লাগবে"):
   ...
   - For example:
     * "আমাদের ১ মাসের ফুল কোর্সের অফার মূল্য ২,৮০০ টাকা লাগবে।" (বা "৩,০০০ টাকা লাগবে।")
...
`;
  ...
  if (geoSocialProof && (/order|অর্ডার|নিতে চাই|পাঠিয়ে|পাঠান|delivery|পার্সেল/i.test(qLowerFb) || qLowerFb.includes("থেকে"))) {
    ...
    if (isKasturi) {
      return `${geoSocialProof} কস্তুরী পাউডার অর্ডার কনফার্ম করতে আপনার: ১. নাম, ২. সম্পূর্ণ ডেলিভারি ঠিকানা (জেলা ও থানা সহ), ৩. সচল মোবাইল নম্বর লিখে পাঠান। উল্লেখ্য, এই প্রোডাক্টের জন্য ২০০ টাকা অগ্রিম বুকিং প্রযোজ্য, বাকি ২,৬০০ টাকা পার্সেল হাতে পেয়ে পরিশোধ করবেন।`;
    }
  ...
  if (/(?:দাম|price|টাকা|koto|কত|প্রাইস)/i.test(qLowerFb)) {
    ...
    return "জি ভাইয়া, আমাদের প্রিমিয়াম ১ মাসের ফুল কোর্সের অফার মূল্য ২,৮০০ টাকা লাগবে। ক্যাশ অন ডেলিভারিতে পার্সেল হাতে পেয়ে পরিশোধ করবেন।";
  }
  // Final safe fallback
...
function convertBengaliNumbersToWords(text) {
  ...
  t = t.replace(/[২2][,.]?[৬6][০0][০0]/g, 'দুই হাজার ছয়শত');
...
✅ সঠিক তথ্য দিলে আমরা সাথে সাথে অর্ডার নিশ্চিত করব ইনশাআল্লাহ।`;
                  ...
                  const paymentLine = isKasturiOrder
                    ...
                    : isBajikaranOrder
                      ? "💰 মূল্য: ২,০০০ টাকা (বুকিং নিশ্চিত করতে ২০০ টাকা অগ্রিম বিকাশ প্রযোজ্য, বাকি ১,৮০০ টাকা ক্যাশ অন ডেলিভারি)\n📱 বিকাশ পার্সোনাল নম্বর: 01870-023804\n📌 দ্রষ্টব্য: বাজীকরণ হালুয়া পার্সেল বুকিং কনফার্ম করতে 01870-023804 নম্বরে ২০০ টাকা পাঠিয়ে লাস্ট ২/৩ ডিজিট এখানে জানান."
...
কোনো প্রশ্ন থাকলে মেসেজ করুন — আমরা সাহায্য করব ইনশাআল্লাহ। 💚`;
                  ...
                  if (isVoiceMode(senderId)) {
                    const voiceConfirm = isKasturiOrder
                      ? `আলহামদুলিল্লাহ ভাইয়া! আপনার কস্তুরী পাউডারের বুকিং অর্ডারটি গ্রহণ করা হয়েছে। এই প্রোডাক্টের জন্য ২০০ টাকা অগ্রিম বুকিং প্রযোজ্য, বাকি ২,৬০০ টাকা ডেলিভারি ম্যানের কাছে পার্সেল পেয়ে পরিশোধ করবেন। আপনার মোবাইলে ${orderData.phone} নম্বরে যোগাযোগ করা হবে। ধন্যবাদ ভাইয়া।`
