...
- উপাদান: ১০০% খাঁটি প্রাকৃতিক কস্তুরী, দুর্লভ প্রাকৃতিক ভেষজ ও খনিজ উপাদান।
- কার্যকারিতা: শারীরিক ক্লান্তি দূর করা, শুক্রাণুর সংখ্যা ও ঘনত্ব বৃদ্ধি, নার্ভ ও স্নায়বিক শক্তি মজবুত করা এবং দীর্ঘস্থায়ী শারীরিক সক্ষমতা বৃদ্ধি।
- বিশেষ পেমেন্ট ও ডেলিভারি পলিসি (CRITICAL): শুধুমাত্র এই কস্তুরী পাউডার প্রোডাক্টের ক্ষেত্রে ৫০০ টাকা ডেলিভারি চার্জ অগ্রিম পরিশোধ করে পার্সেল বুকিং কনফার্ম করতে হবে। বাকি টাকা পার্সেল হাতে পেয়ে ক্যাশ অন ডেলিভারিতে পরিশোধ করবেন।
...
নাম্বার =
   ...
   - কস্তুরী পাউডার (Kasturi Powder) স্পেশাল পেমেন্ট রুল:
     কাস্টমার যদি "কস্তুরী পাউডার" নিতে চায় বা অর্ডার করতে চায়, তবে স্পষ্টভাবে জানিয়ে দেবে যে শুধুমাত্র এই কস্তুরী পাউডারের বুকিং নিশ্চিত করতে ৫০০ টাকা ডেলিভারি চার্জ অগ্রিম পরিশোধ করতে হবে। বাকি টাকা কুরিয়ারে পার্সেল হাতে পেয়ে ক্যাশ অন ডেলিভারিতে পরিশোধ করবেন।
...
✅ সঠিক তথ্য দিলে আমরা সাথে সাথে অর্ডার নিশ্চিত করব ইনশাআল্লাহ।`;
                  ...
                  const isKasturiOrder = /কস্তুরী|kosturi|kasturi|আব্দুল করিম/i.test(orderData.product || "");
                  const paymentLine = isKasturiOrder
                    ? "💰 পেমেন্ট: ৫০০ টাকা অগ্রিম ডেলিভারি চার্জ প্রযোজ্য (বাকি টাকা পার্সেল পেয়ে ক্যাশ অন ডেলিভারি)\n📌 দ্রষ্টব্য: কস্তুরী পাউডার বুকিং নিশ্চিত করতে ৫০০ টাকা অগ্রিম ডেলিভারি চার্জ বিকাশ বা নগদে পরিশোধ করতে হবে।"
