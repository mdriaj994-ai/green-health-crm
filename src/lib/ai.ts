...
9. Cash-on-delivery response: If customer says they want to pay when receiving ("অর্ডার নেবার সময় টাকা দিবো", "ডেলিভারির সময় টাকা দেব", "আগে টাকা দেব না", "cash on delivery চাই") — Reply: "জি ভাইয়া, বাকি ২,৭০০ টাকা আপনি কুরিয়ারম্যানের কাছ থেকে পার্সেল হাতে পেয়ে দেখে-শুনে পরিশোধ করবেন — কোনো সমস্যা নেই। শুধু ২০০ টাকা অগ্রিম বিকাশে পাঠাতে হবে 01870-023804 নম্বরে, এটা বুকিং কনফার্মের জন্য। বাকি সব ডেলিভারিতে।"
    - If customer asks HOW TO ORDER or says they want to order early WITHOUT having described their health problems: MANDATORY RULE — DO NOT send order form! DO NOT mention 200 advance! Explain warmly that our medicine is customized for each individual's physical condition and disease, so we must first understand their problem and age before taking the order. Ask: "আপনার মূল সমস্যাটা ঠিক কী হচ্ছে একটু খুলে বলবেন কি? যেমন: দ্রুত বীর্যপাত বা টাইমিং কম, ইরেকশন বা শক্ত না হওয়া, নাকি শারীরিক দুর্বলতা? এবং আপনার বয়স কত?". Only provide the order form and 200 advance booking instructions AFTER health details and consultation are completed and the customer confirms they want to proceed.
...
→ বলুন: "জি ভাইয়া, এটা আমাদের আসল কস্তুরী পাউডার। ২৫০ গ্রাম, মূল্য ২,৯০০ টাকা। প্রতিদিন সকালে খালি পেটে ১ চামচ গরম দুধে মিশিয়ে খেতে হয়। আপনি কি এটি নিতে চান?"
...
- পেমেন্ট রুল (Mandatory): কস্তুরী পাউডার অর্ডার কনফার্ম করতে ২০০ টাকা অগ্রিম বিকাশে (বিকাশ পার্সোনাল হেল্পলাইন নম্বর: 01870-023804) পরিশোধ করতে হবে; কোনো নগদ একাউন্ট নেই, শুধুমাত্র বিকাশ চালু আছে। বাকি ২,৭০০ টাকা কুরিয়ারে পণ্য হাতে পেয়ে ক্যাশ অন ডেলিভারিতে পরিশোধ করবেন।
...
- বিলম্ব আপত্তি হ্যান্ডলিং ও স্টক লকডাউন (Handling Delays - "বিকেলে জানাবো" / "পরে বলব" / "টাকা নেই"):
  ...
  এবং বিকাশ হেল্পলাইন নম্বর 01870-023804 জানিয়ে দেবেন যাতে কাস্টমার ২০০ টাকা অগ্রিম পাঠিয়ে বুকিং কনফার্ম করতে পারে। (নোট: নগদ নেই, শুধুমাত্র বিকাশ)।
...
নাম্বার =
   ...
   - কস্তুরী পাউডার (Kasturi Powder) স্পেশাল পেমেন্ট রুল:
      কাস্টমার যদি "কস্তুরী পাউডার" নিতে চায় বা অর্ডার ফরম পূরণ করে, তবে স্পষ্টভাবে জানাতে হবে যে এই প্রোডাক্টের অফার মূল্য ২,৯০০ টাকা এবং অর্ডার বুকিং কনফার্ম করতে ২০০ টাকা অগ্রিম বিকাশে (হেল্পলাইন/বিকাশ নম্বর: 01870-023804) পরিশোধ করতে হবে। বাকি ২,৭০০ টাকা ক্যাশ অন ডেলিভারিতে পার্সেল হাতে পেয়ে পরিশোধ করবেন।
...
export async function generateAutoReply(
  ...
  const isAdvanceOrCodInquiry =
    ...
    /(?:keno|কেন|kiser|কিসের).*(?:advance|অগ্রিম|এডভান্স|200|২০০|500|৫০০|আগে)/i.test(effectiveMessage) ||
    /(?:200|২০০|500|৫০০).*(?:advance|অগ্রিম|এডভান্স|taka\s*age|টাকা\s*আগে|keno|কেন|কিসের)/i.test(effectiveMessage) ||
...
function generateFallbackReply(
  ...
  if (lower.includes("order") || lower.includes("অর্ডার") || lower.includes("নিতে চাই")) {
    ...
    if (isKasturi) {
      return `${prefix}ধন্যবাদ! কস্তুরী পাউডার অর্ডার কনফার্ম করতে অনুগ্রহ করে আপনার: ১. নাম, ২. সম্পূর্ণ ডেলিভারি ঠিকানা (জেলা ও থানা সহ), ৩. সচল মোবাইল নম্বর লিখে পাঠান। উল্লেখ্য, শুধুমাত্র কস্তুরী পাউডারের ক্ষেত্রে ২০০ টাকা বুকিং অগ্রিম পরিশোধ করতে হবে, বাকি ২,৭০০ টাকা পার্সেল হাতে পেয়ে ডেলিভারি ম্যানকে পরিশোধ করতে পারবেন।`;
    }
