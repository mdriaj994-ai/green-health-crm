...
আপনার শারীরিক অবস্থা অনুযায়ী কোনটি প্রয়োজন ভাইয়া?`;
  ...
  if (isDelayIntent) {
    const delayReplies = [
      ...
      `ঠিক আছে ভাইয়া, একদম কোনো তাড়াহুড়ো নেই। আপনি কাজের শেষে অবসর মতো সময়ে মেসেজ দিয়েন। তবে ভাইয়া, একজন শুভাকাঙ্ক্ষী হিসেবে শুধু এতটুকু বলব—এই ধরণের গোপন সমস্যা পুষে রাখলে নার্ভগুলো ধীরে ধীরে আরও দুর্বল হয়ে পড়ে, তাই অবহেলা করবেন না। আপনি ফ্রি হয়ে জানালে আপনার জন্য ফ্রেশ ফাইলটি রেডি রাখার ব্যবস্থা করব। সুস্থ থাকুন ভাইয়া।`,
