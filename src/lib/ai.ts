...
সারা দেশে কুরিয়ারে হোম ডেলিভারি দেওয়া হয়।`;
  ...
  if (isPriceQuery && !/(?:samprotik|somosya|সমস্যা|durbol|দুর্বল)/i.test(trimmedClean)) {
    ...
    // Generic price query — symptom-first consultative approach

    const priceVariations = [

      `জি ভাইয়া, আমাদের ১ মাসের ফুল কোর্স (২৫০ গ্রাম) খাঁটি কস্তুরী পাউডারের বর্তমান অফার মূল্য মাত্র ২,৮০০ টাকা। বাকি ২,৩০০ টাকা পার্সেল হাতে পেয়ে দেখে দেবেন, শুধু ৫০০ টাকা বুকিং বিকাশে। তবে ভাইয়া, আপনার ঠিক কোন সমস্যার জন্য জানতে চাচ্ছেন? আপনার অবস্থা বুঝে আমি আরও ভালো গাইড করতে পারব।`,

      `জি ভাইয়া, কস্তুরী পাউডারের অফার মূল্য ২,৮০০ টাকা — ৫০০ টাকা অগ্রিম বিকাশে, বাকি ২,৩০০ টাকা পার্সেল হাতে পেয়ে। ভাইয়া, আপনার কি কোনো নির্দিষ্ট শারীরিক সমস্যা আছে? জানালে বলতে পারব এটি আপনার জন্য কতটুকু কার্যকর হবে।`,

      `জি ভাইয়া, ১ মাসের ফুল কোর্সের দাম ২,৮০০ টাকা। সারাদেশে ক্যাশ অন ডেলিভারিতে পাঠানো হয়। ভাইয়া, একটু বলবেন কি — আপনার কোন ধরনের শারীরিক সমস্যা হচ্ছে? তাহলে বুঝতে পারব এটি আপনার জন্য সঠিক কিনা।`

    ];

    const pReply = priceVariations[Math.floor(Math.random() * priceVariations.length)];
...
আপনার শারীরিক অবস্থা অনুযায়ী কোনটি প্রয়োজন ভাইয়া?`;
  ...
  if (isDelayIntent) {
    const delayReplies = [
      `আচ্ছা ঠিক আছে ভাই, বিকেলে বা রাতে যখনই ফ্রি হন জানাবেন। আমি আপনার জন্য একটি বয়াম স্টক হোল্ড করে রাখছি। তবে একটা কথা মনে রাখবেন ভাইয়া — এই ধরনের সমস্যা দেরি করলে নার্ভ আরও দুর্বল হয়ে পড়ে, পরে সারাতে সময় বেশি লাগে। বিকাশ নম্বর: 01870-023804।`,
      `আচ্ছা ভাই, কোনো সমস্যা নেই। যখন সুবিধামতো মনে করবেন তখন জানাবেন। একটি বয়াম স্টক হোল্ড করে রাখলাম। শুধু একটু মাথায় রাখবেন — এই সমস্যা দিন দিন বাড়তে থাকে, সঠিক সময়ে নিলে দ্রুত সুফল পাবেন। হেল্পলাইন: 01870-023804।`,
      `ঠিক আছে ভাইয়া, আপনার সুবিধামতো সময়ে জানাবেন। একটি বয়াম আপনার নামে রেখে দিচ্ছি। তবে ভাইয়া — টেস্টোস্টেরন হরমোন প্রতিদিনই একটু একটু করে কমছে, যত তাড়াতাড়ি শুরু করবেন তত দ্রুত ফলাফল পাবেন। বিকাশ নম্বর: 01870-023804।`
    ];
