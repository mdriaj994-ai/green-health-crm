...
function generateFallbackReply(
  ...
  if (/(?:কস্তুরী|kasturi|kosturi)/i.test(lower)) {
    if (lower.includes("dam") || lower.includes("price") || lower.includes("কত") || lower.includes("টাকা") || lower.includes("koto")) {
      return "জি ভাইয়া, আমাদের ২৫০ গ্রামের খাঁটি কস্তুরী পাউডারের অফার মূল্য ২,৮০০ টাকা লাগবে। অর্ডার বুকিং কনফার্ম করতে ৫০০ টাকা অগ্রিম বিকাশ বা নগদে (01870-023804) পরিশোধ করতে হবে, বাকি ২,৩০০ টাকা ক্যাশ অন ডেলিভারিতে পার্সেল হাতে পেয়ে পরিশোধ করবেন।";
    }
